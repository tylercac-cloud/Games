...
const fs=require('fs');const s=fs.readFileSync(__dirname+'/../../edge-lab/edge-lab-v7.html','utf8');
...
"\nmodule.exports={normCdf,normInv,expMaxSR,psr,effN,budgetN,moments,sharpe,sma,rsi,signal,barReturns,trades,tradesX,barX,barsPerYear,mds80,runEngine,drift,combos,cscvPBO,decayTest,synth,bundledBars,validateBars,parseCsv,sweepSet,SWEEP,PARAMS,avgCorr,splitCsv,executionAudit,positionPlan,curveStats};\n");
